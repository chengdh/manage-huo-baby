  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved deposit as @deposit" do
        ...
        post :create, {:deposit => {}}, valid_session
        assigns(:deposit).should be_a_new(Deposit)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested deposit" do
        ...
        Deposit.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => deposit.to_param, :deposit => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the deposit as @deposit" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Deposit.any_instance.stub(:save).and_return(false)
        put :update, {:id => deposit.to_param, :deposit => {}}, valid_session
        assigns(:deposit).should eq(deposit)
      end
